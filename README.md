#### Схема и создание БД стримингового музыкального сервиса, тестирование БД SELECT-запросами, группировкой, выборкой из нескольких таблиц

Проект схемы (таблицы и связи между ними), а также SQL-запросы, создающие и тестриующие спроектированную БД для стримингового музыкального сервиса.
...
Тестирование [SELECT-запросов, группировки, выборки из нескольких таблиц](select_and_group.sql), которые выведут информацию согласно инструкциям ниже:  
